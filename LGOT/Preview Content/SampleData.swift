...
extension User: Samplable {
    ...
    static var sample: User {
        User(username: "nat@gmail.com",  userPreferences: .sample, conversations: [.sample, .sample2, .sample3])
    }
    static var sample2: User {
        User(username: "ada@gmail.com",  userPreferences: .sample2, conversations: [.sample, .sample2])
    }
    static var sample3: User {
        User(username: "phoebee@gmail.com",  userPreferences: .sample3, conversations: [.sample, .sample3])
    }
}
...
extension UserPreferences: Samplable {
    ...
    static var sample = UserPreferences(displayName: "Natalie Wright", photo: .sample)
    static var sample2 = UserPreferences(displayName: "Ada Gosk", photo: .sample2)
    static var sample3 = UserPreferences(displayName: "Phoebee Cadrez", photo: .sample3)
}
...
extension Member: Samplable {
    ...
    static var sample: Member {
        Member(userName: "nat@gmail.com", state: .active)
    }
    static var sample2: Member {
        Member(userName: "ada@gmail.com", state: .active)
    }
    static var sample3: Member {
        Member(userName: "phoebee@gmail.com", state: .pending)
    }
}
...
extension Photo: Samplable {
    ...
    static var sample: Photo { Photo(photoName: "Nat") }
    static var sample2: Photo { Photo(photoName: "Ada") }
    static var sample3: Photo { Photo(photoName: "Phoebee") }
