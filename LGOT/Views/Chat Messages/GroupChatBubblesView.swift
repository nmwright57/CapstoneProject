...
struct GroupChatBubblesView: View {
...
struct GroupChatBubblesView_Previews: PreviewProvider {
    static var previews: some View {
        Realm.bootstrap()
        
        return AppearancePreviews(GroupChatBubblesView(user: .sample, isPreview: true))
